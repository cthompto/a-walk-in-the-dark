...
let direction5 = true;
var frameLengthMS = 1000 / 33; //30 fps
var previousTime = 0;
...
function props6(depthOffset) {
  ...
  for (let i = 0; i < 50; i++) {
    ...
    for (let j = 0; j < 33; j++) {
      ...
      if (i < 25) {
        mesh.position.set(i * 15 + 100, j * 15 - 240, 0 + depthOffset);
      } else {
        mesh.position.set(i * 15 - 850, j * 15 - 240, 0 + depthOffset);
      }
